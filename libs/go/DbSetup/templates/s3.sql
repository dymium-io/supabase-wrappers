...
EXECUTE format('CREATE SERVER {{.Server}} FOREIGN DATA WRAPPER s3_wrapper OPTIONS (vault_access_key_id %L, vault_secret_access_key %L, aws_region %L )',key_id, secret_key_id, '{{.S3Region}}');
