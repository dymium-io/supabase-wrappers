...
var connector_test_1 = `{"id":null,"name":"connector0","accesskey":"ft4k3d0eFgl6","secret":"zARKSG2yar9CrJOK0mMisGXR8LlsK5tGLt8UOkYK6KijaGBGE7A8sIzU-KEYYXQaCUytZtJ8Gk8jmvfYFq1Ftlup-mnnONg01WCaI5yFXc6aXHCiURhIS5MXr80ruguK","tunnels":[{"id":"","name":"Tunnel 0","address":"localhost","port":"5432","localport":null,"status":null},{"id":"","name":"tunnel 1","address":"test.test.com","port":"4234"}]}`
var connector_test_2 = `{"id":null,"name":"connector1","accesskey":"ft4k3d0eFgl6","secret":"zARKSG2yar9CrJOK0mMisGXR8LlsK5tGLt8UOkYK6KijaGBGE7A8sIzU-KEYYXQaCUytZtJ8Gk8jmvfYFq1Ftlup-mnnONg01WCaI5yFXc6aXHCiURhIS5MXr80ruguK","tunnels":[{"id":"","name":"Tunnel 0","address":"localhost","port":"5432","localport":null,"status":null},{"id":"","name":"tunnel 1","address":"test.test.com","port":"4234"}]}`
...
func TestApiHandlers(t *testing.T) {
	...
	*/
	...
	func(test string) {
		...
		require.Equal(t, nil, err, fmt.Errorf("Unmarshaling error: %s\n", err))
		if status.Status != "OK" {
			fmt.Printf("Properly failed on creating duplicate connector %s\n", status.Errormessage)
			return
		} else {
			t.Errorf("Created a duplicate connector")
		}
	}(connector_test_1)
	*/
}
