...
export const ConnectionPortsType_as_strings = [ 'PostgreSQL_5432', 'MySQL_3306', 'MariaDB_3306', 'SqlServer_1433', 'OracleDB_1521', 'DB2_50000', 'MongoDB_27017', 'Elasticsearch_9200', 'S3_443' ] as const;
...
export const ConnectionType_as_strings = [ 'PostgreSQL', 'MySQL', 'MariaDB', 'SqlServer', 'OracleDB', 'DB2', 'MongoDB', 'Elasticsearch', 'S3' ] as const;
...
export function humanReadableConnectionType(__a__ : ConnectionType) : string {
  switch(__a__) {
    ...
    case 'S3': return 'S3 (Parquet, CSV, JSON)';
  }
  return '';
}
