...
CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 \
           go build -a -tags netgo -ldflags '-X 'main.MajorVersion=0' -X 'main.MinorVersion=5' -X 'main.ProtocolVersion=4' -w -extldflags "-static"' -o ../GUI/dymiumgui.app/Contents/MacOS/dymium
cd ../GUI
