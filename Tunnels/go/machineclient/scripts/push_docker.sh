...
docker tag machinetunnel:latest public.ecr.aws/a9d3u0m7/dymiummachinetunnel:${tag}
docker tag machinetunnel:latest public.ecr.aws/a9d3u0m7/dymiummachinetunnel:latest 
