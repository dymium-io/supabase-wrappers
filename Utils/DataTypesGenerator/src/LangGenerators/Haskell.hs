...
genModule
  ...
  mDef = do
    ...
    writeFileUtf8 inst [text|-- this file is automatically generated.
    -- !!! DO NOT EDIT !!!
...
enumDef nameMappers thisModName eDef = [text|
    data ${cen} =
      $def
...
enumJSON nameMappers thisModName eDef = [text|
...
structJSON nameMappers thisModName sDef = [text|
  ...
  where
    ...
    fld omitEmpty (n, Field { container, typ }) =
      case typ of
        BoolS   -> [text|"${n}" .= toEmptyable (_${fn} o)|]
        IntS    -> [text|"${n}" .= toEmptyable (_${fn} o)|]
        DoubleS -> [text|"${n}" .= toEmptyable (_${fn} o)|]
        DollarS -> [text|"${n}" .= toEmptyable (_${fn} o)|]
        YearS   -> [text|"${n}" .= toEmptyable (_${fn} o)|]
        PhoneS  -> [text|"${n}" .= toEmptyable (_${fn} o)|]
        DateS   -> [text|"${n}" .= toEmptyable (_${fn} o)|]
        Enum _ Nothing _ ->
                   [text|"${n}" .= toEmptyable (_${fn} o)|]
        _ | omitEmpty ->
           case container of
             Opt      -> [text|maybe mempty ("${n}" .=) (_${fn} o)|]
             OptLst _ -> [text|maybe mempty ("${n}" .=) (_${fn} o)|]
             _        -> [text|"${n}" .= _${fn} o|]
        _ -> [text|"${n}" .= _${fn} o|]
      where fn = structFldMapper nameMappers thisModName (sn, n)

enumDefault :: NameMappers -> Text -> EnumDef -> Text
enumDefault nameMappers thisModName EnumDef { eName, eDflt } = [text|
...
structDefault nameMappers thisModName sDef = [text|
    ...
    fld (_, Field { moduleName, typ, container, dflt }) =
      ...
      then
        ...
        case (container, typ, dflt) of
          ...
          _ -> error $ "Wrong default: "<>show sDef<>" in module "<>show moduleName
