...
, fgl, file-embed, foldl, hashable, hasql, hasql-pool, hasql-th
, hasql-transaction, Interpolation, lens, lib, megaparsec, mtl
, optparse-applicative, optparse-text, path, path-io, text, time
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    hashable hasql hasql-pool hasql-th hasql-transaction Interpolation
    lens megaparsec mtl path path-io text unordered-containers vector
  ];
