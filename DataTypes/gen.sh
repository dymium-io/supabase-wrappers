...
../bin/dataTypesGenerator -l golang -p ../web/go/src/types -r dymium/types DbAnalyzer.hdtd
../bin/dataTypesGenerator -l golang -p ../web/go/src/types -r dymium/types DbSync.hdtd
